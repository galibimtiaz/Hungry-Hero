...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("HungryHero", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("HungryHero", null, 1024, 768);
		#end
		#else
		create (null);
		#end
	...
	public static function create (config):Void {
		...
		app.meta["file"] = "HungryHero";
		app.meta["name"] = "HungryHero";
		app.meta["packageName"] = "com.sample.hungryhero";
	...
	macro public static function getEntryPoint () {
		...
		switch (Context.follow (Context.getType ("HungryHero"))) {
			...
			case TInst (t, params):
				...
				if (hasMain) {
					...
					return Context.parse ("@:privateAccess HungryHero.main ()", Context.currentPos ());
					...
					Context.fatalError ("Main class \"HungryHero\" has neither a static main nor a constructor.", Context.currentPos ());
					
				}
				
			default:
				
				Context.fatalError ("Main class \"HungryHero\" isn't a class.", Context.currentPos ());
...
@:keep @:dox(hide) class DocumentClass extends HungryHero {}
